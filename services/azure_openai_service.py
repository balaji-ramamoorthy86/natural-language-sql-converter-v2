...
class AzureOpenAIService:
    ...
    def _fallback_sql_generation(self, natural_language: str, schema_context: str = "") -> Dict[str, Any]:
        ...
        elif 'insert' in nl_lower or 'add' in nl_lower or 'update' in nl_lower or 'modify' in nl_lower or 'change' in nl_lower or 'delete' in nl_lower or 'remove' in nl_lower or 'drop' in nl_lower or 'create' in nl_lower:
            return {
                'success': False,
                'error': 'Only SELECT queries are allowed. Data modification operations (INSERT, UPDATE, DELETE, DROP, CREATE) are prohibited for security.',
                'fallback': True
            }
